...
class etuan_cart
{
    ...
    function submit($buyer_id, $credit_used, $shipmethod_id, $payment_id, $address_id, $memo)
    {
        $sn = dgmdate(time(), 'YmdHis').mt_rand(10,99);
        $product_fee = $this->getProductFee();
        ...
        $order_id = DB::insert('etuan_order', compact('sn', 'buyer_id', 'bought_at', 'credit_used', 'shipmethod_id', 'payment_id', 'address_id', 'actual_fee', 'product_fee', 'ship_fee', 'credit_used', 'memo'), true);
